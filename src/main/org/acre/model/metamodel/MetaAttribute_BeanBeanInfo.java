...
public class MetaAttribute_BeanBeanInfo extends SimpleBeanInfo {

    Class beanClass = MetaAttribute_Bean.class;

    public MetaAttribute_BeanBeanInfo() {
    }
...
} // end class MetaAttribute_BeanBeanInfo
