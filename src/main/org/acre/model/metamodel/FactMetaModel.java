...
public class FactMetaModel {
    private static FactMetaModel instance;
    ...
    public static FactMetaModel getInstance() {
        if (instance == null) {
            ...
            instance = new FactMetaModel();
        }
        return instance;
    }


    private FactMetaModel() {
...
//                childType.insertIntoMetaRelationships(invRelationship);
    ...
    public static void main(String[] args) {
        MetaModel[] mms = FactMetaModel.getInstance().getModels();
