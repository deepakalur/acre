...
public final class AFirstBinorAdditiveExpr extends PAdditiveExpr
{
    private TIdentifier _identifier_;
    private TBinor _binor_;
    private PMultiplicativeExpr _multiplicativeExpr_;

    public AFirstBinorAdditiveExpr()
    {
    }
    ...
    public Object clone()
    {
        return new AFirstBinorAdditiveExpr(
    ...
    {
        ((Analysis) sw).caseAFirstBinorAdditiveExpr(this);
    }
