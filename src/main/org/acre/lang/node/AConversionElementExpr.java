...
public final class AConversionElementExpr extends PExpr
{
    ...
    public Object clone()
    {
        return new AConversionElementExpr(
    ...
    {
        ((Analysis) sw).caseAConversionElementExpr(this);
    }
