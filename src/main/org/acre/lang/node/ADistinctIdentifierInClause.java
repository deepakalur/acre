...
public final class ADistinctIdentifierInClause extends PInClause
{
    ...
    public ADistinctIdentifierInClause()
    {
    }
    ...
    public Object clone()
    {
        return new ADistinctIdentifierInClause(
    ...
    {
        ((Analysis) sw).caseADistinctIdentifierInClause(this);
    }
