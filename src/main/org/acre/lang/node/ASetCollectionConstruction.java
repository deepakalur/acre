...
public final class ASetCollectionConstruction extends PCollectionConstruction
{
    private TSet _set_;
    ...
    public ASetCollectionConstruction()
    {
    }
    ...
    public Object clone()
    {
        return new ASetCollectionConstruction(
    ...
    {
        ((Analysis) sw).caseASetCollectionConstruction(this);
    }
