...
public final class AConversionFlattenExpr extends PExpr
{
    ...
    public Object clone()
    {
        return new AConversionFlattenExpr(
    ...
    {
        ((Analysis) sw).caseAConversionFlattenExpr(this);
    }
