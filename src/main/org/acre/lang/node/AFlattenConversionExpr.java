...
public final class AFlattenConversionExpr extends PConversionExpr
{
    ...
    public Object clone()
    {
        return new AFlattenConversionExpr(
    ...
    {
        ((Analysis) sw).caseAFlattenConversionExpr(this);
    }
