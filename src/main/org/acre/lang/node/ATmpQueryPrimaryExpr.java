...
public final class ATmpQueryPrimaryExpr extends PPrimaryExpr
{
    ...
    public Object clone()
    {
        return new ATmpQueryPrimaryExpr(
    ...
    {
        ((Analysis) sw).caseATmpQueryPrimaryExpr(this);
    }
