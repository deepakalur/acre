...
public final class AUniqueCollectionExpr extends PCollectionExpr
{
    ...
    public Object clone()
    {
        return new AUniqueCollectionExpr(
    ...
    {
        ((Analysis) sw).caseAUniqueCollectionExpr(this);
    }
