...
public final class ALastCollectionExpr extends PCollectionExpr
{
    ...
    public Object clone()
    {
        return new ALastCollectionExpr(
    ...
    {
        ((Analysis) sw).caseALastCollectionExpr(this);
    }
