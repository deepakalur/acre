...
public final class AListCollectionConstruction extends PCollectionConstruction
{
    ...
    public AListCollectionConstruction()
    {
    }
    ...
    public Object clone()
    {
        return new AListCollectionConstruction(
    ...
    {
        ((Analysis) sw).caseAListCollectionConstruction(this);
    }
