...
public final class AFirstCollectionExpr extends PCollectionExpr
{
    ...
    public Object clone()
    {
        return new AFirstCollectionExpr(
    ...
    {
        ((Analysis) sw).caseAFirstCollectionExpr(this);
    }
