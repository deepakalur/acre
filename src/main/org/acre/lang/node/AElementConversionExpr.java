...
public final class AElementConversionExpr extends PConversionExpr
{
    ...
    public Object clone()
    {
        return new AElementConversionExpr(
    ...
    {
        ((Analysis) sw).caseAElementConversionExpr(this);
    }
