...
public final class AFirstTmpRelationalExpr extends PTmpRelationalExpr
{
    ...
    public AFirstTmpRelationalExpr()
    {
    }
    ...
    public Object clone()
    {
        return new AFirstTmpRelationalExpr(
    ...
    {
        ((Analysis) sw).caseAFirstTmpRelationalExpr(this);
    }
