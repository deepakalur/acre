...
public final class ASingleBracketedTupleList extends PBracketedTupleList
{
    ...
    public ASingleBracketedTupleList()
    {
    }
    ...
    public Object clone()
    {
        return new ASingleBracketedTupleList(
    ...
    {
        ((Analysis) sw).caseASingleBracketedTupleList(this);
    }
