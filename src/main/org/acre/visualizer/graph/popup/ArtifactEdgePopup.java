 ...
 * @version Dec 22, 2004 10:57:27 PM
 */
public class ArtifactEdgePopup extends GraphPopup {

    public ArtifactEdgePopup(AcreGraph graph, ArtifactEdge artifactEdge) {
        super(graph, artifactEdge, "Artifacts Relationship");
    }
