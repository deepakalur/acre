 ...
 * @version Dec 22, 2004 10:51:40 PM
 */
public class PDMResultVertexPopup extends GraphPopup {

    public PDMResultVertexPopup(AcreGraph graph, PDMResultVertex pdmResultVertex) {
        super(graph, pdmResultVertex, "PDM Result");
    }
