 ...
 * @version Dec 22, 2004 10:55:16 PM
 */
public class RoleResultToRoleResultEdgePopup extends GraphPopup {

    public RoleResultToRoleResultEdgePopup(AcreGraph graph,
                                         RoleResultToRoleResultEdge roleResultToRoleResultEdge) {
        super(graph, roleResultToRoleResultEdge, "Role Result Relationship");
    }
