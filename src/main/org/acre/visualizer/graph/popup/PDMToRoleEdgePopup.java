 ...
 * @version Dec 22, 2004 11:26:08 PM
 */
public class PDMToRoleEdgePopup extends GraphPopup {

    public PDMToRoleEdgePopup(AcreGraph graph, PDMToRoleEdge pdmToRoleEdge) {
        super(graph, pdmToRoleEdge, "PDM-Role Relationship");
    }
