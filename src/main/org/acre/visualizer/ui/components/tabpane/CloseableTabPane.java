 ...
 */
package org.acre.visualizer.ui.components.tabpane;
 ...
 * closes the tab.
 */
public class CloseableTabPane extends JTabbedPane implements MouseListener,
  MouseMotionListener {
   ...
   */
  public CloseableTabPane(int horizontalTextPosition) {
    super();
  ...
  class CloseableMetalTabbedPaneUI extends MetalTabbedPaneUI {
    ...
    */
    ...
    public class CloseableTabbedPaneListener implements EventListener {
    ...
    public static void main (String args[]) {
        ...
        CloseableTabPane t = new CloseableTabPane();
        t.add(new JLabel("Tab 1"));
        t.add(new JLabel("Tab 2"));
