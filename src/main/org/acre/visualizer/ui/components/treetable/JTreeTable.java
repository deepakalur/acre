...
public class JTreeTable extends JTable {
    ...
    // introduced by deepak alur to allow the event handler to get hold
    // of the wrapper and check if the tree is being updated
    public ListToTreeSelectionModelWrapper getSelectionWrapper() {
	...
	protected boolean         updatingListSelectionModel;
        ...
        public boolean isUpdatingListSelectionModel() {
            return updatingListSelectionModel;
        }
